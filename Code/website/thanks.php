...
<body>
    ...
    <div id="memory_board">
		<?php
		if(isset($_SESSION['question_count']) && $_SESSION['question_count'] >= $max_questions){
		?>
		<div id="rate_first">
		...
		Do you have any suggestions? (Length, questions, appearance, correctness, lay-out etc.) 
		Please, leave them in the text field below. It will automatically submit after
