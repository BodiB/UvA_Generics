...
<html>
    ...
    <body>
        ...
        <div id="myText">
            In this study, you will learn about the animals that live on two Galapagos islands called the Marchena island and the Genovesa island. Because of the geography of the Galapagos, there are small genetic variations between the animals of
            the same species that live on the two islands. In particular, they often show differences in colouring. Here is the map of the islands:</br>
            </br>
