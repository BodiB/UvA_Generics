...
<ul>
	...
	<li>Then, it is your opponent’s turn to play: they will first uncover a piece of data about the Marchena island, and then you can uncover a piece of data about the Genovesa island. If the two pieces look identical, then your opponent wins a point. Otherwise, no one wins a point. </li>
</ul>
...
In this study, we would like you to learn about <?php echo $max_questions; ?> different species that live on the Marchena and Genovesa islands, so you will be asked to play the game <?php echo $max_questions; ?> times. </br>
</br>
